...
<!--[if gt IE 8 | IEMobile]><!--><html <?php language_attributes(); ?>><!--<![endif]-->
	...
	<head>
		...
		<!-- Stylesheet -->
		<link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,300|Open+Sans+Condensed:300,300italic' rel='stylesheet' type='text/css'>
		<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/kraken.css">
	...
	<body>
	<div data-sticky-wrap class="sticky-wrap">
		...
		<?php get_template_part( 'nav-main', 'Site Navigation Main' ); ?>
		<?php get_template_part( 'header-image', 'Header Image' ); ?>
